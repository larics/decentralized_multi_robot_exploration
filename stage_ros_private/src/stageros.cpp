...
private:
    ...
    static tf2_ros::StaticTransformBroadcaster tf_static;
  ...
  if( ! ros::ok() ) {
    ...
    for (size_t r = 0; r < this->robotmodels_.size(); ++r)
    {
        ...
        for (size_t s = 0; s < robotmodel->lasermodels.size(); ++s)
        {
            ...
            //geometry_msgs::Vector3 laserT;
            //auto laserT = tf::Point(lp.x, lp.y, robotmodel->positionmodel->GetGeom().size.z + lp.z);
            //geometry_msgs::TransformStamped static_transformStamped;
            //static_transformStamped.header.stamp = ros::Time::now();
            //static_transformStamped.header.frame_id = "base_link";
            //static_transformStamped.child_frame_id = "base_laser_link";

            //static_transformStamped.transform.translation.x = laserT.x();
            //static_transformStamped.transform.translation.y = laserT.y();
            //static_transformStamped.transform.translation.z = laserT.z();
           
            //static_transformStamped.transform.rotation.x = laserQ.x();
            //static_transformStamped.transform.rotation.y = laserQ.y();
            //static_transformStamped.transform.rotation.z = laserQ.z();
            //static_transformStamped.transform.rotation.w = laserQ.w();
            //tf_static.sendTransform(static_transformStamped);
       ...
       // this->odomMsgs[r].stall = this->positionmodels[r]->Stall();
        //
        odom_msg.header.frame_id = mapName("base_pose_ground_truth", r, static_cast<Stg::Model*>(robotmodel->positionmodel));
        ...
        ground_truth_msg.child_frame_id = mapName("base_link", r, static_cast<Stg::Model*>(robotmodel->positionmodel));
